...
__C.TRAIN.STOP_THRESHOLDS = (0.0001, 0.0001, 0.0001)
...
__C.CDD.ALIGNMENT_FEAT_KEYS = ['probs']
__C.CDD.INTRA_ONLY = False

# INNparameter
__C.HYPER = edict()
__C.HYPER.BLOCK_NUM = 5
__C.HYPER.SWAP_WEIGHT = 0.3
__C.HYPER.ALIGN_WEIGHT = 0.5
